      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <form action="../admin/MemberUpdate.do" method="post">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <tr>
                    <td><input type="hidden" name="id" value="${mdto.id}">${mdto.id}</td>
                    <td><input type="text" name="pass" value="${mdto.pass}"> </td>
                    <td><input type="text" name="name" value="${mdto.name}"></td>
                    <td><input type="text" name="email" value="${mdto.email}"></td>
                    <td><input type="text" name="hcall" value="${mdto.hcall}"></td>
                    <td><input type="text" name="phone" value="${mdto.phone}"></td>
                    <td><input type="text" name="address" value="${mdto.address}"></td>
                    <td>
 
                   		<label for="admin">관리자</label>
                   		<input type="radio" id="admin" name="grade" value="0" checked>
                   		<label for="normal">일반</label>
                   		<input type="radio" id="normal" name="grade" value="1">
                    </td>
                  </tr>
                </tbody>
              </table>
