...
<script type="text/javascript">
	...
	function agree(){
		...
		if($('#agreement1').prop('checked') == false){
			...
			$(location).attr('href','/project2/member/join02.jsp');
		}
	}
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<p style="text-align:center; margin-bottom:20px"><a href="javascript:agree();"><img src="../images/btn01.gif" /></a>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
