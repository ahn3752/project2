...
function email_input(obj){
    document.regiform.email_2.value= obj.options[obj.selectedIndex].value;
}
...
function check(){
	var url = "../member/IdCheckctrl.do?id="+ document.regiform.id.value;
	window.open(url,
			"_blank_1",
 ...
 <body>
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<form action="../member/join.do" name="regiform" method="post">
				...
				<table cellpadding="0" cellspacing="0" border="0" class="join_box">
					...
					<tr>
						...
						<td><input type="text" name="id"  value="" class="join_input" />&nbsp;<a onclick="check()" style="cursor:hand;"><img src="../images/btn_idcheck.gif" alt="중복확인"/></a>
	...
	<select name="last_email_check2" onchange="email_input(this);" class="pass" id="last_email_check2" >
		...
		<option value="yahoo.com" >yahoo.com</option>
				...
				<p style="text-align:center; margin-bottom:20px"><input type="image" src="../images/btn01.gif"/></a>&nbsp;&nbsp;<a href="/main/main.jsp"><img src="../images/btn02.gif" /></a></p>
		</form>
