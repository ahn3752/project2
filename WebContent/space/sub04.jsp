...
<form class="form-inline">	
    ...
    <td align="center" width="190">
        <img alt="" src="../Upload/${bdto.attachedfile}" width="190" height="190"><br>
         <a href="../space/free.view?flag=${param.flag}&idx=${bdto.idx }&nowPage=${map.nowPage}&searchColumn=${param.searchColumn }&searchWord=${param.searchWord}">${bdto.title}
   	</td>
  <%
  	if(i==3){
  		out.print("</tr>");
